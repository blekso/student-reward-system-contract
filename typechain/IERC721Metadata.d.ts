...
interface IERC721MetadataInterface extends Interface {
  functions: {
...
export class IERC721Metadata extends Contract {
  connect(signerOrProvider: Signer | Provider | string): IERC721Metadata;
  attach(addressOrName: string): IERC721Metadata;
  deployed(): Promise<IERC721Metadata>;

  on(event: EventFilter | string, listener: Listener): IERC721Metadata;
  once(event: EventFilter | string, listener: Listener): IERC721Metadata;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): IERC721Metadata;
  removeAllListeners(eventName: EventFilter | string): IERC721Metadata;
  removeListener(eventName: any, listener: Listener): IERC721Metadata;
